...
bot = telebot.TeleBot('8778944344:AAEg3AWMBth9ZfdHzB2PRg_VMO38wwsDFes')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @KadamisBack ❄."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @KadamisBack")
...
Buy From :- @KadamisBack
Official Channel :- https://t.me/+q0BraxUBe5A3MWNl
'''
...
3. MAKE SURE YOU JOINED https://t.me/+q0BraxUBe5A3MWNl OTHERWISE NOT WORK
